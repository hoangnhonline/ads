...
$model = new Backend;
$link = "index.php?mod=reservation&act=list";
...
<div class="row">
    <div class="col-md-12">    
         <div class="box-header">
                <h2 class="box-title" style="text-tranform:uppercase !important;color: #333333">RESERVATION LIST</h2>
            </div><!-- /.box-header -->
        <div class="box">
            <div class="box_search col-md-12" style="text-align:left">
                <form method="get" id="form_search" name="form_search">                    
                    ...
                    <input type="hidden" name="mod" value="reservation" />
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap">                            
                            <a href="javascript:;" alias="<?php echo $row['name']; ?>" id="<?php echo $row['id']; ?>" mod="reservation" class="link_delete" >
