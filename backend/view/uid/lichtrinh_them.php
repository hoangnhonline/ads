                        ...
                        <td colspan="2">
                            <div class="row" id="row_<?php echo $i; ?>">
                                ...
                                <div style="margin-bottom:10px">
                                   <div class="col-md-6">
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_vi[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_vi[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_vi[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_vi[<?php echo $i; ?>][]"></textarea>
                                   </div>
                                   <div class="col-md-6">
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_en[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_en[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_en[<?php echo $i; ?>][]"></textarea>
                                    <textarea style="margin-bottom:5px" class="form-control" rows="2" name="content_en[<?php echo $i; ?>][]"></textarea>                          
                                   </div>
